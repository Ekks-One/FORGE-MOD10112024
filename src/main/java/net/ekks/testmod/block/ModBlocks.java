package net.ekks.testmod.block;
...
public class ModBlocks {
    ...
    //This Method Registers an item associated with the block item Method
    // Since DeferredRegister<Block> doesn't have one associated initially using this helper method.
